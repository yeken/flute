...
$.widget("ui.multiselect", {
  options: {
	...
	_create: function() {
		...
		this.selectedList = $('<ul id="div_selected" class="list selected"><li class="ui-helper-hidden-accessible"></li></ul>').bind('selectstart', function(){return false;}).appendTo(this.selectedContainer);
...
$.extend($.ui.multiselect, {
	...
	locale: {
		...
		itemsCount:'#{count} items seleccionados',
		itemsTotal:'#{count} items total',
		busy:'Aguarde por favor...',

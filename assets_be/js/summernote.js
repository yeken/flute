    ...
    this.setLinkDialog = function ($editable, fnShowDialog) {
      ...
      fnShowDialog({
		...
		if (agent.bMSIE && rng.isCollapsed()) {
          ...
          document.execCommand("insertHTML",false,'<a target="'+target+'" href="'+sLinkUrlWithProtocol+'">'+displayText+'</a>');
		}
      });
    };
                   ...
                   '<div class="modal-content">' +
                     ...
                     '<div class="modal-body">' +
                       ...
                       '<div class="form-group">' +
                         ...
                         '<input type="text" class="note-link-text form-control input-xlarge" id="modal-link-text" />' +
                       '</div>' +
                       '<div class="form-group">' +
					   ...
					   '<div class="form-group">' +
                         ...
                         '<input class="note-link-url form-control col-md-11" type="text" />' +
                       '</div>' +
